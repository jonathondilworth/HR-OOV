...
echo "[Step 1/3] Extracting questions from './data/benchmark.json ... "
...
echo "[Step 2/3] Preparing SpaCy dependencies for running NER on './data/benchmark-questions.json ... "
...
echo "[Step 3/3] Running NER on './data/benchmark-questions.json to build ./data/benchmark-questions-with-entities.json ... "
