...
output_file = '../logs/oov_entity_mentions_d_equals_one_results.json'
with open(output_file, 'w') as f:
    json.dump(all_results, f, indent=2)

print(f"All results saved to {output_file}")

output_macro_pr_auc_file = '../logs/oov_entity_mentions_d_equals_one__PR_AUC_POINTS_4_PLOT.json'
...
print(latextable.draw_latex(
    ...
    caption="Performance of fetching single targets using OOV mentions with lambda={0.1,0.15,0.37} (50 Queries)",
    use_booktabs=True, position="H", caption_above=True, caption_short="Single target performance of OOV mentions, lambda={0.1,0.15,0.37}",
